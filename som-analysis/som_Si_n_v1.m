...
% Load data
% load('workspace_som_Si_n_norm_var_v0.mat', 'Xmaps', 'fit_parameters', 'Xsom', 'X', 'nonempty_col')
load('workspace_som_Si_n_norm_lin_nomsize_v0.mat', 'Xmaps', 'fit_parameters', 'Xsom', 'X', 'nonempty_col')
